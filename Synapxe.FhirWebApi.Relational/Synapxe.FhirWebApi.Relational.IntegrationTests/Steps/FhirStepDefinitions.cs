...
namespace Synapxe.FhirWebApi.Relational.IntegrationTests.Steps
{
    [Binding]
    public sealed class FhirStepDefinitions
    {
        ...
        public FhirStepDefinitions(ScenarioContext scenarioContext, IFhirWebApplication webApp, ITestOutputHelper testOutput)
        {
